...
<div class="row">
  ...
  <p>Please Note: This event booking form is linked to your single sign on, please therefore only book a place for yourself and not on behalf of someone else.</p>
	...
	<?php echo $this->Html->script('AADEvents/script.js'); ?>

	<div class="waf-include">

    <!-- Form -->
		<?php echo $this->Form->create($person, [ 'context' => ['validator' => 'register'] ]); ?>
		...
		<?php if (count($events) > 0) : ?>
			...
			<?php
					echo $this->Form->control('surname', ['label' => 'Surname', 'default'=>$person->surname]);
					echo $this->Form->control('forename', ['label' => 'First name', 'default'=>$person->forename]);
					echo $this->Form->control('title', ['label' => 'Title', 'default'=>$person->title]);
